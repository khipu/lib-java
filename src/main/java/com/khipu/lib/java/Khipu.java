...
public class Khipu {
	...
	public static final String API_URL = "https://khipu.com/api/1.3/";
	...
	/**
	 * Entrega un servicio para obtener la información de notificación instantanea de khipu.
	 *
	 * @param receiverId id de cobrador
	 * @param secret     llave de cobrador
	 * @return el servicio para obtener la información de notificación de un pago.
	 * @see KhipuGetPaymentNotification
	 * @since 2013-05-24
	 */
	public static KhipuGetPaymentNotification gePaymentNotification(int receiverId, String secret) {
		return new KhipuGetPaymentNotification(receiverId, secret);
	}
	 ...
	 * @since 2013-05-24
	 */
	public static String getPaymentButton(int receiverId, String secret, String email, String bankId, String subject, String body, int amount, Date expiresDate, String notifyUrl, String returnUrl, String cancelUrl, String pictureUrl, String custom, String transactionId, String button) {
	...
	private static String getConcatenated(int receiverId, String email, String bankId, String subject, String body, int amount, Date expiresDate, String notifyUrl, String returnUrl, String cancelUrl, String pictureUrl, String custom, String transactionId) {
		StringBuilder builder = new StringBuilder();
		...
		builder.append("&expires_date=").append(expiresDate != null ? expiresDate.getTime() / 1000 : "");
